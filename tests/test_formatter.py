...
class SetupLoggingTests(unittest.TestCase):
    ...
    def test_explicit_notset_level_overrides_existing_logger_level(self):
        logger_name = "test_explicit_notset"
        original = logging.getLogger(logger_name)
        original.setLevel(logging.ERROR)

        logger, _ = self._make_stream_logger(logger_name=logger_name, level=logging.NOTSET)
